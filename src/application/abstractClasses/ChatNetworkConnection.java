...
public abstract class ChatNetworkConnection {

    private ConnectionThread connThread = new ConnectionThread();
    private Consumer<Serializable> onReceivedCallback;

    public ChatNetworkConnection(Consumer<Serializable> onReceivedCallback){
    ...
    public void closeConnection() throws Exception{
        try{
            ...
            System.out.println("Null on close socket");
        }
    }
