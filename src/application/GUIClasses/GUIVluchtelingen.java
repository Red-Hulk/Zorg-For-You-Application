...
import application.BackEndClasses.Vluchtelingen;
...
public class GUIVluchtelingen extends LeftPanelCategoriesGUI {

    public GUIVluchtelingen(Stage primaryStage) {
        setUpLeftPanel();
        ...
        new Vluchtelingen(btnChat, btnFAQ, btnNoodNummers, primaryStage);
    }
}
